        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
                ...
                <Transition enter-active-class="transition-all duration-300 ease-out"
                    ...
                    <div v-if="showCalculator" class="mt-3 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 space-y-2 shadow-sm">
                ...
                <Transition enter-active-class="transition-all duration-300 ease-out"
                    ...
                    <div v-if="hasInsufficientBalance"
                        ...
                        <p class="text-sm text-red-700 flex items-center gap-2 font-medium">
                            ...
                            <span>
                                Insufficient balance! Available: <strong>{{ formatCurrency(authStore.user?.balance) }}</strong>
                            </span>
                        </p>
                    </div>
                </Transition>
