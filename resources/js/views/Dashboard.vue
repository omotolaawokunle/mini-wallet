<template>
    <div class="min-h-screen bg-gray-50">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div v-if="authStore.user?.is_flagged" class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-md">
                <div class="flex items-start">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>{{ authStore.user?.flagged_reason || 'Your account has been flagged due to a balance discrepancy.' }}
                            </p>
                            <p class="mt-2">You cannot make transactions until this issue is resolved. Please contact
                                support.</p>
                        </div>
                    </div>
                </div>
